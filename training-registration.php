...
<html>
<head>
<title>FIFA Players Management System | Training Regitration Form</title>
...
<div class="mation">
					...
					<span>Defenders</span>
						<select class="form-control" required="true" name="bowlingpace">
							<option value="Choose Bowling Pace">Choose Bowling Pace</option>
					...
					<div class="mation">
						...
						<input type="radio"  name="fpreference" value="All Rounder">All Rounder
						<input type="radio" name="fpreference" value="Goal keeper">Goal keeper
